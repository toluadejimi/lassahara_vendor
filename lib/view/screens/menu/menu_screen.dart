...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<MenuModel> _menuList = [
      ...
      MenuModel(icon: Images.user, title: 'Delete account'.tr, route: ''),
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            return MenuButton(menu: _menuList[index], isProfile: index == 0, isLogout: index == _menuList.length-1, deleteAccount: _menuList[index].title=='Delete account',);
          },
        ),
