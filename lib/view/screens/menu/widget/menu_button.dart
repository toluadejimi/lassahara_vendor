...
class MenuButton extends StatelessWidget {
  ...
  final bool isLogout, deleteAccount;
  MenuButton({@required this.menu, @required this.isProfile, @required this.isLogout, this.deleteAccount });
      ...
      onTap: () {
        if(menu.isBlocked) {
          ...
          if(deleteAccount == true){
            Get.dialog(ConfirmationDialog(icon: Images.support, description: 'are_you_sure_to_delete_account'.tr, isLogOut: true, onYesPressed: () {
              Get.find<AuthController>().deletedAccount().then((value) {
                if(value == true){
